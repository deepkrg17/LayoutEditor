...
import com.itsvks.editor.databinding.LayoutColorDialogBinding;
import com.itsvks.editor.view.ColorView;
...
public class ColorDialog extends AttributeDialog
  ...
  public ColorDialog(Context context, String savedValue) {
    ...
    inputLayout = dialogView.findViewById(R.id.text_input_layout);
    editText = dialogView.findViewById(R.id.text_input_edittext);
  ...
  public void onProgressChanged(SeekBar seek, int progress, boolean fromUser) {
    if (fromUser) {
      int seekId = seek.getId();
      if (seekId == R.id.seek_alpha) {
        colorPreview.setAlpha(progress);
      } else if (seekId == R.id.seek_red) {
        colorPreview.setRed(progress);
      } else if (seekId == R.id.seek_green) {
        colorPreview.setGreen(progress);
      } else if (seekId == R.id.seek_blue) {
