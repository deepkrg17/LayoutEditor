...
import com.itsvks.editor.databinding.LayoutSizeDialogBinding;
...
public class SizeDialog extends AttributeDialog {
  ...
  public SizeDialog(Context context, String savedValue) {
    ...
    textInputLayout = dialogView.findViewById(R.id.text_input_layout);
    textInputLayout.setHint("Enter dimension value");
    textInputLayout.setSuffixText("dp");

    textInputEditText = dialogView.findViewById(R.id.text_input_edittext);
