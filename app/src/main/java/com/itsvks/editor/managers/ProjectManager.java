...
public class ProjectManager {
  ...
  public String getColorsXml() {
    return FileIOUtils.readFile2String(openedProject.getColorsPath());
  }

  public String getStringsXml() {
    return FileIOUtils.readFile2String(openedProject.getStringsPath());
  }
  ...
  private ArrayList<HashMap<String, Object>> convertJsonToJavaObject(String filePath) {
    return new Gson()
        .fromJson(
            ResourceUtils.readAssets2String(filePath),
