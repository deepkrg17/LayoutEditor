...
public class ConstraintLayoutCaller {
	...
	public static void setLeftToLeft(View target, String value, Context context) {
		...
		if(value.equals("parent")) {
			...
			set.connect(target.getId(), ConstraintSet.LEFT, IdManager.getViewId(value), ConstraintSet.LEFT);
		}
	...
	public static void setLeftToRight(View target, String value, Context context) {
		...
		if(value.equals("parent")) {
			...
			set.connect(target.getId(), ConstraintSet.LEFT, IdManager.getViewId(value), ConstraintSet.RIGHT);
		}
	...
	public static void setRightToLeft(View target, String value, Context context) {
		...
		if(value.equals("parent")) {
			...
			set.connect(target.getId(), ConstraintSet.RIGHT, IdManager.getViewId(value), ConstraintSet.LEFT);
		}
	...
	public static void setRightToRight(View target, String value, Context context) {
		...
		if(value.equals("parent")) {
			set.connect(target.getId(), ConstraintSet.RIGHT, ConstraintSet.PARENT_ID, ConstraintSet.RIGHT);
		}
		else {
			set.connect(target.getId(), ConstraintSet.RIGHT, IdManager.getViewId(value), ConstraintSet.RIGHT);
		}
	...
	public static void setTopToBottom(View target, String value, Context context) {
		...
		if(value.equals("parent")) {
			...
			set.connect(target.getId(), ConstraintSet.TOP, IdManager.getViewId(value), ConstraintSet.BOTTOM);
		}
	...
	public static void setBottomToTop(View target, String value, Context context) {
		...
		if(value.equals("parent")) {
			...
			set.connect(target.getId(), ConstraintSet.BOTTOM, IdManager.getViewId(value), ConstraintSet.TOP);
		}
	...
	public static void setBottomToBottom(View target, String value, Context context) {
		...
		if(value.equals("parent")) {
			set.connect(target.getId(), ConstraintSet.BOTTOM, ConstraintSet.PARENT_ID, ConstraintSet.BOTTOM);
		}
		else {
			set.connect(target.getId(), ConstraintSet.BOTTOM, IdManager.getViewId(value), ConstraintSet.BOTTOM);
		}
	...
	public static void setBaselineToBaseline(View target, String value, Context context) {
		...
		if(value.equals("parent")) {
			set.connect(target.getId(), ConstraintSet.BASELINE, ConstraintSet.PARENT_ID, ConstraintSet.BASELINE);
		}
		else {
			set.connect(target.getId(), ConstraintSet.BASELINE, IdManager.getViewId(value), ConstraintSet.BASELINE);
		}
	...
	public static void setStartToStart(View target, String value, Context context) {
		...
		if(value.equals("parent")) {
			set.connect(target.getId(), ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START);
		}
		else {
			set.connect(target.getId(), ConstraintSet.START, IdManager.getViewId(value), ConstraintSet.START);
		}
	...
	public static void setStartToEnd(View target, String value, Context context) {
		...
		if(value.equals("parent")) {
			...
			set.connect(target.getId(), ConstraintSet.START, IdManager.getViewId(value), ConstraintSet.END);
		}
	...
	public static void setEndToStart(View target, String value, Context context) {
		...
		if(value.equals("parent")) {
			...
			set.connect(target.getId(), ConstraintSet.END, IdManager.getViewId(value), ConstraintSet.START);
		}
