...
public class EditorLayout extends LinearLayoutCompat {
            ...
            case DragEvent.ACTION_DRAG_ENTERED:
              if (shadow.getParent() == null) addWidget(shadow, parent, event);
                ...
                if (parent instanceof LinearLayoutCompat) {
                  ...
                  int newIndex = getIndexForNewChildOfLinear((LinearLayoutCompat) parent, event);
  ...
  public void loadLayoutFromParser(String xml) {
    ...
    initializer =
        new AttributeInitializer(getContext(), viewAttributeMap, attributes, parentAttributes);
  }
