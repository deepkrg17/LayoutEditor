package com.itsvks.editor.vectormaster.models;
...
import com.itsvks.editor.vectormaster.DefaultValues;
import com.itsvks.editor.vectormaster.utilities.Utils;
import com.itsvks.editor.vectormaster.utilities.parser.PathParser;
...
public class PathModel {
  ...
  public void buildPath(boolean useLegacyParser) {
    if (pathData != null) {
      if (useLegacyParser) {
        originalPath =
            com.itsvks.editor.vectormaster.utilities.legacyparser.PathParser
